...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-card rounded-md",
        ...
        vintage: "bg-vintage-gold text-vintage-dark hover:bg-vintage-gold/90 shadow-vintage font-display tracking-wider uppercase rounded-md",
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-elegant font-display tracking-widest uppercase text-base rounded-md",
      },
      size: {
